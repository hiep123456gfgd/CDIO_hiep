				...
				<ul class="navbar-nav justify-content-start flex-grow-1 gap-1">
					...
					<ul class="dropdown-menu">
					  ...
					  <li class="nav-item dropdown">
						...
						<ul class="dropdown-menu">
							<router-link to="/QLDanhMuc">
								<li> <a class="dropdown-item" href="form-elements.html"><i class="bx bx-right-arrow-alt"></i>Quản Lý Danh Mục</a>
							</li>
							</router-link>
							<router-link to="/QLProduct">
								<li> <a class="dropdown-item" href="form-input-group.html"><i class="bx bx-right-arrow-alt"></i>Quản Lý Sản Phẩm</a>
							</li>
							</router-link>
